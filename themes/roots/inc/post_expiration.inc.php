...
if ($_GET['post_type'] == '' || $_['post_type'] == 'jobs')
{
...
function expirationdate_meta_page() {
	add_meta_box('expirationdatediv', __('Set Post Expiration','post-expirator'), 'expirationdate_meta_box', 'post', 'advanced', 'high');
}
...
function expirationdate_meta_custom() {
    ...
    //foreach ($custom_post_types as $t) {
       	add_meta_box('expirationdatediv', __('Set Job / RFP Expiration','post-expirator'), 'expirationdate_meta_box', 'jobs', 'advanced', 'high');
    //}
}
...
function expirationdate_meta_box($post) { 
	...
	$rv[] = '<label for="enable-expirationdate">'.__('Enable Expiration','post-expirator').'</label></p>';
	$rv[] = '<table><tr>';
	...
	$rv[] = '</tr><tr>';
	$rv[] = '<td>';	
		$rv[] = '<select name="expirationdate_year" id="expirationdate_year">';
		$currentyear = date('Y');
		...
		$rv[] = '</select>';
	$rv[] = '</td><td>';
		$rv[] = '<select name="expirationdate_month" id="expirationdate_month">';
		for($i = 1; $i <= 12; $i++) {
	...
	$rv[] = '</select>';	 
	$rv[] = '</td><td>';
		$rv[] = '<input type="text" id="expirationdate_day" name="expirationdate_day" value="'.$defaultday.'" size="2" />,';
	$rv[] = '</td></tr><tr>';
	...
	$rv[] = '<td>@</td><td>';
	 /* $rv[] = '<input type="text" id="expirationdate_hour" name="expirationdate_hour" value="'.$defaulthour.'" size="2"'.$disabled.'" />'; */
		...
		$rv[] = '</td><td>';
		$rv[] = '<input type="text" id="expirationdate_minute" name="expirationdate_minute" value="'.$defaultminute.'" size="2" />';
